...
note_5 = Note.create!(author_id: demouser.id,
...
note_6 = Note.create!(author_id: demouser.id,
      notebook_id: notebook2.id,
...
note_7 = Note.create!(author_id: demouser.id,
      notebook_id: notebook2.id,
      title: "Become Hogwarts Headmaster",
      body: <<-TEXT
...
note_8 = Note.create!(author_id: demouser.id,
      notebook_id: notebook2.id,
      title: "Ride a Dragon",
      body: <<-TEXT
